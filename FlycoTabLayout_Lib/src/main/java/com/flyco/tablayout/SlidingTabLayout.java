...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mIndicatorPadding;//仅在style在BLOCK模式下生效
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(8));
        ...
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(12));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable.setBounds((int) (mIndicatorPadding + mIndicatorMarginLeft + mIndicatorRect.left),
                        (int) mIndicatorMarginTop, (int) (mIndicatorRect.right - mIndicatorMarginRight - mIndicatorPadding),
